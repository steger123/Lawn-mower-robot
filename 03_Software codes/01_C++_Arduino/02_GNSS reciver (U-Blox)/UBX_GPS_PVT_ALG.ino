...
const unsigned char ESF_ALG_HEADER[] = { 0x10, 0x14 }; 
...
struct ESF_ALG {
  ...
  unsigned char error;			//U1
  unsigned char res;				//U1
...
void loop() {
  ...
  if ( msgType == MT_NAV_PVT ) {
    Serial.print("iTOW:");      Serial.print(ubxMessage.navPvt.iTOW);
